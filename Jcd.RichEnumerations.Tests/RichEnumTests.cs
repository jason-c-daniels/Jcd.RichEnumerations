...
public class RichEnumTests
{
   ...
   [Fact]
   public void RichEnum_op_Equals_Returns_True_With_Two_Null_Values()
   {
   ...
   [Fact]
   public void RichEnum_op_Equals_Returns_False_With_One_Null_Value()
   {
   ...
   [Fact]
   public void RichEnum_GetHashCode_Returns_Expected_Value()
   {
   ...
   [InlineData(2)]
   [InlineData(10)]
   public void RichEnum_Conversion_Operator_Round_Trip_Returns_Original_Value(int value)
   {
   ...
   public void RichEnum_Equals_Operator_Returns_Expected_Value(int value1, int value2, bool expectedValue)
   {
   ...
   [InlineData(2,  1, true)]
   public void RichEnum_Not_Equals_Operator_Returns_Expected_Value(int value1, int value2, bool expectedValue)
   {
      var ev1 = (MySimpleEnum) value1;
      var ev2 = (MySimpleEnum) value2;
      Assert.Equal(expectedValue, ev1 != ev2);
   ...
   [InlineData(7)]
   [InlineData(111)]
   public void RichEnum_Conversion_Operator_Throws_Exception_When_Given_Invalid_Value(int value)
   {
