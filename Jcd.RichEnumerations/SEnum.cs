...
public abstract class SEnum<TEnum>(int value) : SEnum<int, TEnum>(value)
    where TEnum : SEnum<TEnum>;
...
public abstract class SEnum<TValue, TEnum>(TValue value) :
    SEnumBase<TValue, TEnum, TEnum>,
    IEquatable<TEnum>,
    IEnumValueProvider<TValue>,
    IComparable<TEnum>,
    IComparable<SEnum<TValue, TEnum>>
    where TValue : IEquatable<TValue>
    where TEnum : SEnum<TValue, TEnum> 
{
    /// <summary>
    ...
    /// <inheritdoc />
    public int CompareTo(SEnum<TValue, TEnum>? other)
    {
    ...
    /// <returns>True if equivalent.</returns>
    public static bool operator ==(SEnum<TValue, TEnum>? l, SEnum<TValue, TEnum>? r)
    {
    ...
    public static explicit operator TValue(SEnum<TValue, TEnum> e) => e.Value;
    ...
    public static explicit operator SEnum<TValue, TEnum>(TValue value)
    {
