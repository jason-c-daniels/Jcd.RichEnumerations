...
public abstract class SortableRichEnum<TValue, TEnum>(TValue value) : SortableRichEnumBase<TValue, TEnum, TEnum>
                                                                    , IEquatable<TEnum>
   ...
   where TEnum : SortableRichEnum<TValue, TEnum>
{
   ...
   /// <summary>
   /// Compares the Value of the current <see cref="SortableRichEnum{TValue,TEnum}"/> instance to the target instance for equality.
   /// </summary>
   ...
   /// <summary>
   /// Compares two <see cref="SortableRichEnum{TValue,TEnum}"/> instances to determine if the left hand side is less than the right hand side.
   /// </summary>
   /// <param name="l">the left hand side of the comparison.</param>
   /// <param name="r">the right hand side of the comparison.</param>
   ...
   /// <summary>
   /// Compares two <see cref="SortableRichEnum{TValue,TEnum}"/> instances to determine if the left hand side is greater than the right hand side.
   /// </summary>
   /// <param name="l">the left hand side of the comparison.</param>
   /// <param name="r">the right hand side of the comparison.</param>
   ...
   /// <summary>
   /// Compares two <see cref="SortableRichEnum{TValue,TEnum}"/> instances to determine if the left hand side is less than or equal to the right hand side.
   /// </summary>
   /// <param name="l">the left hand side of the comparison.</param>
   /// <param name="r">the right hand side of the comparison.</param>
   ...
   /// <summary>
   /// Compares two <see cref="SortableRichEnum{TValue,TEnum}"/> instances to determine if the left hand side is greater than or equal to the right hand side.
   /// </summary>
   /// <param name="l">the left hand side of the comparison.</param>
   /// <param name="r">the right hand side of the comparison.</param>
   ...
   public static explicit operator TValue(SortableRichEnum<TValue, TEnum> e) { return e.Value; }

   /// <summary>
   /// Explicit conversion from the underlying data type to an <see cref="SortableRichEnum{TValue,TEnum}"/> instance. This performs a lookup on the known values.
   /// </summary>
   /// <param name="value">The value to convert.</param>
   /// <returns>The instance of the <see cref="SortableRichEnum{TValue,TEnum}"/>, if it exists. Throws an exception, otherwise.</returns>
