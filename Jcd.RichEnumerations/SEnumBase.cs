...
public abstract class SEnumBase<TValue, TEnumeration, TEnumeratedItem> 
    : SEnumBase<TEnumeration, TEnumeratedItem>
...
/// <typeparam name="TEnumeration">The type of the enumeration containing the enumerated items</typeparam>
/// <typeparam name="TEnumeratedItem">The type of the enumerated data.</typeparam>
public abstract class SEnumBase<TEnumeration, TEnumeratedItem>
    : EnumBase<TEnumeration, TEnumeratedItem>
