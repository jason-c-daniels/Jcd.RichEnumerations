...
public abstract class NamedSortableRichEnum<TEnum>(int value, string name)
   : NamedSortableRichEnum<int, TEnum>(value, name)
   where TEnum : NamedSortableRichEnum<TEnum>;
