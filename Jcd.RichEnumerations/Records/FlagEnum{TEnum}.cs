...
public abstract record FlagEnum<TEnum>
   ...
   where TEnum : FlagEnum<TEnum>, IEquatable<TEnum>, IValueProvider<ulong>, new()
{
   ...
   /// <summary>
   /// Compares the Value of the current <see cref="FlagEnum{TEnum}" /> instance to the target instance for
   /// equality.
   /// </summary>
