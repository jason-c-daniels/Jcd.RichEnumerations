...
```csharp
public static TValue explicit operator TValue(Jcd.RichEnumerations.SortableRichEnum<TValue,TEnum> e);
```
#### Parameters

<a name='Jcd.RichEnumerations.SortableRichEnum_TValue,TEnum_.op_ExplicitTValue(Jcd.RichEnumerations.SortableRichEnum_TValue,TEnum_).e'></a>
