...
<a name='Jcd.RichEnumerations.Classes.DomainValue_TValue,TType_.DomainValue(TValue).value'></a>

`value` [TValue](DomainValue_TValue,TType_.md#Jcd.RichEnumerations.Classes.DomainValue_TValue,TType_.TValue 'Jcd.RichEnumerations.Classes.DomainValue<TValue,TType>.TValue')