    ...
    : SNdEnum<ExampleEnum2>(value, name, description)
{
    ...
    public static ExampleEnum2 Item2 = new(2, "ExampleEnum2.Item2", "The second item.");
    public static ExampleEnum2 Item1 = new(1, "ExampleEnum2.Item1", "The first item.");
    public static ExampleEnum2 Unset = new(0, "ExampleEnum2.Unset", "The value is not yet set.");
    ...
    public override int CompareTo(ExampleEnum2 other)
    {
